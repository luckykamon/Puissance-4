...
def power4():
  ...
  tyellow = pygame.image.load("tyellow.png").convert()
  tred = pygame.image.load("tred.png").convert()
  while True:
    while True:
      if n > 41: #tray is full
          window.blit(pygame.image.load("equality.png").convert(), (245, 100))
          pygame.display.flip()
          menu()
...
def tray(coord1, coord2, color): #display pion
  ...
  if color == 1:
    piony = pygame.image.load("piony.png").convert()
...
def result(b, k1, c1, k2, c2, k3, c3, k4, c4): #display 4 pion which player can win
  ...
  tray(c4, k4, c)
  if b[k1][c1] == 1:
    window.blit(pygame.image.load("wyellow.png").convert(), (80, 525))
  else:
    window.blit(pygame.image.load("wred.png").convert(), (80, 525))
  pygame.display.flip()
